...
function Index() {
    ...
    const script = () => {
        ...
        setInterval(() => {
            const sentence = [
                "Prenez place , les phrases <span vont s écrire et défilleront automatiquement sur l ecran ",
                "Vous n avez a vous occupez de rien , juste a prendre conscience sur vous",
                `
                    A la lecture de ses lignes, vous allez ralentir pour prendre une inspiration plus lente et une expiration apaisante , plus calme ,
                `,
                ...
                `
                    <li >Perdre du poids superflu me rendra optimiste et heureux</li>
        ...
        {showOn == false ? (<>
            ...
            <div className='relative min-h-[600px]'>
                <div className='sentence'>
                    <div dangerouslySetInnerHTML={{__html:sentenceP}} className='px-8 pt-[100px] items-center text-[#6b89c9] text-center text-[22px] md:text-[30px]' ></div>
                </div>
            </div>
        </>)}
    </>
