...
function PresentationMoi() {
    ...
    return (<div className=' section1 p-5 lg:px-[100px] lg:py-[70px]'>
        <ComponenthDeuxTraitBleu title="Rémi PRADERE, hypnose à Toulouse
mon parcours de vie"/>
        <div className='block shadow-none  lg:shadow-[#6b89c9] lg:shadow-2xl lg:flex mt-[50px] w-[100%]'>
            ...
            <div data-aos="fade-right" className='px-7 w-[100%] lg:shadow-xl rounded-md lg:w-4/6 '>
               
                    <h3 className="pt-6 text-[#decb8c] text-[25px] text-center mt-1 mb-5 w-[100%]">Rémi PRADERE votre hypnothérapeute sur Toulouse</h3>
